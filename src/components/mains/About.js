            ...
            <div>
                ...
                <div className="page-section">
                    <InText width='40%' minWidth="300px" float='left'>
                        <Image
                            imgSrc={require("../../pics/grass-2.jpg")}
                        />
                    </InText>
                ...
                <div className="page-section clear-float">
                    <InText width='40%' minWidth="300px" float='left'>
                        <Image 
                            imgSrc={require("../../pics/krakow.jpg")}
                            caption="Krakow, Quality in Official Statistics 2018"
                        />
                    </InText>
                    <Text>
                        <p>
                ...
                <div className="page-section clear-float">
                    <InText width='40%' minWidth="300px" float='left'>
                        <Image 
                            imgSrc={require("../../pics/norway-bikes.jpg")}
                            caption="Bike trip with a guitar on board, Norway 2019"
                        />
                    </InText>

                    <InText width='40%' minWidth="300px" float='right'>
                        <Image 
                            imgSrc={require("../../pics/nepal.jpg")}
                ...
                <div className="page-section clear-float">
                    <InText width='40%' minWidth="300px" float='left'>
                        <Image 
                            imgSrc={require("../../pics/usa.jpg")}
                            caption="Last day at Dough Roller pizzeria, Ocean City, US, 2012"
                        />
                    </InText>
                    ...
                    <InText width='40%' minWidth="300px" float='right'>
                        <Image 
                            imgSrc={require("../../pics/first-pizza-hunt.png")}
                            caption={<>
                                My first ever official <a href="http://ferovpizzaquest.blogspot.com/2013/02/pizzeria-boccaccio-v-nitre-15.html">pizza hunt</a> in 
                                Nitra, 2013
                            </>}
                        />
                    </InText>
                    ...
                    <InText width='40%' minWidth="300px" float='left'>
                        <Image 
                            imgSrc={require("../../pics/ripc.jpg")}
                            caption="In Real Italian Pizza Company, 2015"
                        />
                    </InText>
                ...
                <div className="page-section">
                    <InText width='40%' minWidth="300px" float='left'>
                        <Image 
                            ...
                            caption="Oslo jam session meetup, 2014"
                        />
                    </InText>

                    <InText width='40%' minWidth="300px" float='right'>
                        <Image 
                            imgSrc={require("../../pics/bergen.jpg")}
                            caption="Street-play tour, Bergen, 2015"
                        />
                    </InText>

                    <InText width='40%' minWidth="300px" float='right'>
                        <Image 
                            imgSrc={require("../../pics/ghana.jpg")}
                            caption="At AIMS, Ghana, 2015"
                        />
                    </InText>
